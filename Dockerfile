...
RUN /bin/bash -c "source ~/elasticsearch2/bin/activate && ES_MAJOR_VERSION=2 pip install --upgrade pip && pip install --upgrade setuptools && pip install digsandpaper && pip install etk && python -m spacy download en"
RUN /bin/bash -c "source ~/elasticsearch5/bin/activate && ES_MAJOR_VERSION=5 pip install --upgrade pip && pip install --upgrade setuptools && pip install digsandpaper && pip install etk && python -m spacy download en"
